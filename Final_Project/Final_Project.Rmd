...
#save(train, test, train1, test1, grouped_train_data,group_data_category, ordered_data,top_5, file = "originalData.Rda")
```
...
#m2 <- multinom(Category ~ PdDistrict + DayOfWeek, data = train_samp, maxit = 100)
```
