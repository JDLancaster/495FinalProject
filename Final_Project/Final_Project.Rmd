...
load(file = "originalData.rda")
load(file = "modelsCV.rda")
load(file = "modelsFolds.rda")
...
The following map shows San Francisco broken down by Police Districts. This map gives us a better idea on the scope of the project and helps us to visually identify the Police District names found in our data set.  
